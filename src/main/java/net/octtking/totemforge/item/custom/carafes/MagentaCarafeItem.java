package net.octtking.totemforge.item.custom.carafes;
...
public class MagentaCarafeItem extends Item {
    private static final int MAX_USE_TIME = 75;

    public MagentaCarafeItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (returnitem == 1){
            return new ItemStack(ModItems.FILLED_MAGENTA_CARAFE);
        } else {
