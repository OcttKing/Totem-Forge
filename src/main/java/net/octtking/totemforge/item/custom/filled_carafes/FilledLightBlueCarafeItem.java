package net.octtking.totemforge.item.custom.filled_carafes;
...
public class FilledLightBlueCarafeItem extends Item {
    public FilledLightBlueCarafeItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        return new ItemStack(ModItems.LIGHT_BLUE_CARAFE);
    }
    @Override
