...
public abstract class WorldMod extends World implements WorldAccess, AutoCloseable {
        public static final Codec<RegistryKey<net.minecraft.world.World>> CODEC = RegistryKey.createCodec(RegistryKeys.WORLD);
   // public static final RegistryKey<net.minecraft.world.World> OVERWORLD = RegistryKey.of(RegistryKeys.WORLD, new Identifier("overworld"));
   // public static final RegistryKey<net.minecraft.world.World> NETHER = RegistryKey.of(RegistryKeys.WORLD, new Identifier("the_nether"));
  //  public static final RegistryKey<net.minecraft.world.World> END = RegistryKey.of(RegistryKeys.WORLD, new Identifier("the_end"));
    ...
    private final RegistryKey<net.minecraft.world.World> registryKey;
    ...
    protected WorldMod(
            ...
            RegistryKey<net.minecraft.world.World> registryRef,
     ...
     *
     * @see #createExplosion(Entity, DamageSource, ExplosionBehavior, double, double, double, float, boolean, net.minecraft.world.World.ExplosionSourceType)
     */
    ...
    public Explosion createExplosion(
            @Nullable Entity entity, double x, double y, double z, float power, boolean createFire, net.minecraft.world.World.ExplosionSourceType explosionSourceType
    ) {
    ...
    public Explosion createExplosion(
            ...
            float power,
            boolean createFire,
            net.minecraft.world.World.ExplosionSourceType explosionSourceType
    ) {
...
//import org.jetbrains.annotations.Nullable;
//
//public abstract class WorldMod implements WorldViewMod {
//   // @Deprecated
//    private DynamicRegistryManager registryManager;
//    private ModDamageSources damageSources;
//
//    public WorldMod(DynamicRegistryManager registryManager) {
//        this.registryManager = registryManager;
//        this.damageSources = new ModDamageSources(registryManager);
//    }
//
//
//    @Nullable
...
//    }
//
//    public ModDamageSources getModDamageSources() {
//        return this.damageSources;
//    }
//}
